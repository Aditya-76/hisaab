...
/**
 * Zomato per-order earning.
 *
 *   EN: "Order delivered. ₹38 added to your earnings."
 *       "Order delivered. ₹52 added to your earnings (₹8 customer tip)."
 *   HI: "ऑर्डर डिलीवर हुआ। ₹38 आपकी कमाई में जुड़े।"
 */
const EARNED_RES: readonly RegExp[] = [
  new RegExp(`${INR}\\s*added to your earnings`, "i"),
  new RegExp(`(?:You earned|earned)\\s+${INR}`, "i"),
  new RegExp(`${INR}\\s*(?:आपकी )?कमाई में जुड़े`, "u"),
...
const TIP_RES: readonly RegExp[] = [
  new RegExp(`\\(${INR}\\s*(?:customer\\s+)?tip\\)`, "i"),
